    ...
    <section class="content-wrapper">
        ...
        <form action="" method="post" class="py-3 container">
            <div class="mb-2">
                ...
                <input type="number" class="form-control" id="kode_buku" placeholder="">
            </div>
            <div class="mb-2">
                <label for="judul_buku" class="form-label">Judul Buku</label>
                <input type="text" class="form-control" id="judul_buku" placeholder=" ">
            </div>
            <div class="mb-2">
            ...
            <div class="mb-2">
                ...
                <input type="number" class="form-control" id="tahun_terbit" placeholder="">
            </div>
            <div class="mb-4">
